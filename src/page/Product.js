    ...
    return (
        <main className='main-main'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-6 mt-md-0 mt-4'>
                            <div className='product-info-col'>
                                <h2 className='title product-title'>Everyday Tube Top Ribbed</h2>
                                ...
                                <ul className='d-flex product-size-list'>
                                    ...
                                    <li className='d-flex align-items-center justify-content-center'>S</li>
                                    <li className='d-flex align-items-center justify-content-center'>M</li>
                                </ul>
                                <div className='d-lg-flex justify-content-between mt-lg-5 mt-4 align-items-center'>
                                    ...
                                    <div className="d-flex counter-side-text">
                                        <a className="wishlist d-flex align-items-center">
                                            <svg className="at-icon wishicon added" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                                <path
                                                    className="add"
                                        ...
                                        <a className="ask-ques d-flex align-items-center ms-2">
                                            <svg className="at-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                <path
                                ...
                                <button type='button' className='d-block mt-3 add-cart-btn'>ADD TO CART</button>
                                <div className="freeShipMsg d-flex align-items-center mt-3">
                                    <svg className="at-icon mr5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path
                                    ...
                                    <span className='ps-2'>Spent <b> Rs. 16,900.00 </b> more to get free shipping</span>
                                </div>
                                <div className="shipBar my-3"><span className="db anim"></span></div>
                                <div className="freeShipMsg d-flex align-items-center">
                                    <svg className="at-icon mr10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M400 64h-48V12c0-6.6-5.4-12-12-12h-8c-6.6 0-12 5.4-12 12v52H128V12c0-6.6-5.4-12-12-12h-8c-6.6 0-12 5.4-12 12v52H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zM48 96h352c8.8 0 16 7.2 16 16v48H32v-48c0-8.8 7.2-16 16-16zm352 384H48c-8.8 0-16-7.2-16-16V192h384v272c0 8.8-7.2 16-16 16zM148 320h-40c-6.6 0-12-5.4-12-12v-40c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12zm96 0h-40c-6.6 0-12-5.4-12-12v-40c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12zm96 0h-40c-6.6 0-12-5.4-12-12v-40c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12zm-96 96h-40c-6.6 0-12-5.4-12-12v-40c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12zm-96 0h-40c-6.6 0-12-5.4-12-12v-40c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12zm192 0h-40c-6.6 0-12-5.4-12-12v-40c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12z"></path></svg>
                                    <span className='ps-2'>Estimated delivery between  <b> 23 October - 30 October </b> </span>
                                </div>
                                <span className="border-bottom d-block my-3"></span>
                                <div><img src={safeCheckout} /></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className='section-space pt-0'>
                <div className='container'>
                    <h3 className='title section-title text-center mb-5'>Recommended Products</h3>
                                        ...
                                        <div className='product-col text-center'>
                                            <div className='product-image'>
                                                ...
                                                <ul className='bottom-bar d-flex align-items-center justify-content-center'>
                                                    <li>
                                                        <svg className="at-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path d="M251,51.9c-4.7-5.4-11.8-8.2-21.3-8.2H49.5L44.7,0.7H10.1C4.5,0.7,0,5.2,0,10.8s4.5,10.1,10.1,10.1h16.5l15.2,135.3 c1.1,11.2,9.8,32.2,34.5,32.2h127.9l0.1,0c9.1-0.2,27.2-6.9,31-30.4l20.3-89.1l0.1-0.8C256.1,66.6,256.9,58.7,251,51.9z M215.6,153.8l-0.1,0.7c-1.8,11.8-9.2,13.4-11.6,13.7H76.4c-5.4,0-9-1.9-11.6-6.1c-2.3-3.8-2.8-7.9-2.8-7.9L51.8,64h177.9 c4.2,0,5.8,1,6,1.2c0,0,0,0.1,0.1,0.2L215.6,153.8z"></path><path d="M83.4,198.2c-15.8,0-28.6,12.8-28.6,28.6c0,15.8,12.8,28.6,28.6,28.6s28.6-12.8,28.6-28.6C112,211,99.2,198.2,83.4,198.2z M83.4,237.1c-5.7,0-10.4-4.7-10.4-10.4s4.7-10.4,10.4-10.4c5.7,0,10.4,4.7,10.4,10.4S89.1,237.1,83.4,237.1z"></path><path d="M183,198.2c-15.8,0-28.6,12.8-28.6,28.6c0,15.8,12.8,28.6,28.6,28.6s28.6-12.8,28.6-28.6C211.5,211,198.7,198.2,183,198.2z M183,237.1c-5.7,0-10.4-4.7-10.4-10.4s4.7-10.4,10.4-10.4s10.4,4.7,10.4,10.4S188.7,237.1,183,237.1z"></path></svg>
                                                    </li>
                                                    <li>
                                                        <svg className="at-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path d="M252.9,234.1l-53.4-53.4c-3.1-3.1-7.5-4.3-11.5-3.4c16.3-18.7,26.2-43.2,26.2-69.9c0-58.9-47.9-106.8-106.8-106.8 S0.6,48.5,0.6,107.3s47.9,106.8,106.8,106.8c27.1,0,51.9-10.2,70.8-26.9c-0.8,4,0.4,8.3,3.5,11.4L235,252c2.5,2.5,5.7,3.7,8.9,3.7 c3.2,0,6.5-1.2,8.9-3.7C257.8,247.1,257.8,239.1,252.9,234.1z M107.3,193.9c-47.7,0-86.6-38.8-86.6-86.6s38.8-86.6,86.6-86.6 s86.6,38.8,86.6,86.6S155.1,193.9,107.3,193.9z"></path></svg>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className='product-info'>
                                                <h5 className='product-name'>Long Maxi Dress</h5>
                                                <p className='product-price'>Rs. 6,000.00</p>
